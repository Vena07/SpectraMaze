...
class Bulb(BaseBlock):
    ...
    def draw(self, surface):
        ...
        # Masivní jádro reaktoru
        pygame.draw.circle(surface, (20, 20, 25), self.rect.center, self.size//4)
        pygame.draw.circle(surface, bulb_color, self.rect.center, self.size//4 - 2)
